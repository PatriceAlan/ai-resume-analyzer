...
const Upload = () => {
    ...
    const handleAnalyze: ({companyName, jobTitle, jobDescription, file}: {
        companyName: string;
        jobTitle: string;
        jobDescription: string;
        file: File
    }) => Promise<void> = async({companyName, jobTitle, jobDescription, file}:
        ...
        const feedbackText: 'string'|'number'|'bigint'|'boolean...' = typeof feedback.message.content === 'string'
